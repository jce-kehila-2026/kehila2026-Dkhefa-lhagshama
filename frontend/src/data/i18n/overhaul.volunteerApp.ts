  ...
  he: {
    volunteerApp: {
      ...
      ui: {
        ...
        roleMismatchToast: 'האזור הזה מיועד למתנדבים.',
        backToSite: 'חזרה לאתר',
        save: 'שמירה',
        cancel: 'ביטול',
        submit: 'שליחה',
      ...
      // ── Calendar + availability (WS-7) ───────────────────────
      calendar: {
        title: 'יומן וזמינות',
        subtitle: 'שעות הפעילות הקבועות שלך ותאריכי היעד של הבקשות שלך.',
        availabilityTitle: 'שעות פעילות שבועיות',
        availabilitySub: 'הוסף/י חלונות זמן קבועים שבהם את/ה זמין/ה לטיפול בבקשות.',
        addWindow: 'הוספת חלון זמן',
        removeWindow: 'הסרה',
        day: 'יום',
        startTime: 'משעה',
        endTime: 'עד שעה',
        noWindows: 'עדיין לא הוגדרו שעות פעילות.',
        windowsSaved: 'שעות הפעילות נשמרו.',
        windowsError: 'שמירת שעות הפעילות נכשלה.',
        invalidWindow: 'שעת הסיום חייבת להיות אחרי שעת ההתחלה.',
        unavailableTitle: 'סימון כלא זמין/ה',
        availableAgainLabel: 'מתי תהיה/תהיי זמין/ה שוב? (לא חובה)',
        availableAgainHint: 'בתאריך זה הסטטוס יחזור אוטומטית ל״פנוי/ה״.',
        save: 'שמירה',
        deadlinesTitle: 'תאריכי יעד של הבקשות שלי',
        noDeadlines: 'אין בקשות עם תאריך יעד.',
        legendDeadline: 'תאריך יעד',
        legendAvailable: 'זמינות',
        days: ['א׳', 'ב׳', 'ג׳', 'ד׳', 'ה׳', 'ו׳', 'ש׳'],
  ...
  en: {
    volunteerApp: {
      ...
      ui: {
        ...
        roleMismatchToast: 'This area is for volunteers.',
        backToSite: 'Back to site',
        save: 'Save',
        cancel: 'Cancel',
        submit: 'Submit',
      ...
      calendar: {
        ...
        subtitle: 'Your recurring working hours and your request deadlines.',
        availabilityTitle: 'Weekly working hours',
        availabilitySub: 'Add recurring windows when you are available to take requests.',
        addWindow: 'Add a window',
        removeWindow: 'Remove',
        day: 'Day',
        startTime: 'From',
        endTime: 'To',
        noWindows: 'No working hours set yet.',
        windowsSaved: 'Working hours saved.',
        windowsError: 'Failed to save working hours.',
        invalidWindow: 'End time must be after the start time.',
        unavailableTitle: 'Mark yourself unavailable',
        availableAgainLabel: 'When will you be available again? (optional)',
        availableAgainHint: 'On this date your status returns to "Free" automatically.',
        save: 'Save',
        deadlinesTitle: 'My request deadlines',
        noDeadlines: 'No requests with a deadline.',
        legendDeadline: 'Deadline',
        legendAvailable: 'Availability',
